...
# icon
icon = pygame.image.load('spirit_3.png')
...
# define fonts
font_normal = pygame.font.Font('Pixeltype.ttf', 50)
font_title = pygame.font.Font('Pixeltype.ttf', 65)
...
# load images
start_background_image = pygame.transform.scale(pygame.image.load('bluesky_03.png').convert_alpha(), (900, 500))
menu_image = pygame.transform.scale(pygame.image.load('bluesky_02.png').convert_alpha(), (900, 500))
nox_image = pygame.transform.scale(pygame.image.load('spirit_3.png').convert_alpha(), (200, 200))
user_name_image = pygame.transform.scale(pygame.image.load('username_sky.jpg').convert_alpha(), (900, 500))
username_score_image = pygame.transform.scale(pygame.image.load('username_score.jpg').convert_alpha(),
                                              (900, 500))
todo_background = pygame.transform.scale(pygame.image.load('todosky.jpeg').convert_alpha(), (900, 500))
health_background = pygame.transform.scale(pygame.image.load('mentalhealth.png').convert_alpha(), (900, 500))

SKY = pygame.transform.scale(pygame.image.load('spirit_sky.jpg'), (900, 500)).convert_alpha()
GROUND = pygame.Surface((900, 150))
GROUND.fill('Black')

PURPLEBALL_SURFACE = pygame.transform.scale(pygame.image.load('purple ball.png'), (40, 40)).convert_alpha()
PINKBALL_SURFACE = pygame.transform.scale(pygame.image.load('pink ball.png'), (40, 40)).convert_alpha()

NOX_SURFACE = pygame.image.load('spirit_3.png').convert_alpha()
NOX_RECT = NOX_SURFACE.get_rect(midbottom=(80, 350))

# load button images
quit_img = pygame.transform.scale(pygame.image.load("quit_white.png").convert_alpha(), (100, 35))
back_img = pygame.transform.scale(pygame.image.load('back.png').convert_alpha(), (100, 30))
game_img = pygame.transform.scale(pygame.image.load('gamecorner.png').convert_alpha(), (300, 30))
health_img = pygame.transform.scale(pygame.image.load('mentalhealth.png').convert_alpha(), (300, 30))
todo_img = pygame.transform.scale(pygame.image.load('todolist.png').convert_alpha(), (300, 30))
music1_img = pygame.transform.scale(pygame.image.load('trackone.png').convert_alpha(), (300, 30))
music2_img = pygame.transform.scale(pygame.image.load('tracktwo.png').convert_alpha(), (300, 30))
music3_img = pygame.transform.scale(pygame.image.load('trackthree.png').convert_alpha(), (300, 30))
pause_img = pygame.transform.scale(pygame.image.load('pause.png').convert_alpha(), (100, 30))
resume_img = pygame.transform.scale(pygame.image.load('resume.png').convert_alpha(), (120, 30))
...
# Introduction
NOX_SCREEN = pygame.transform.scale(pygame.image.load('spirit_3.png'), (150, 150)).convert_alpha()
...
spirit_0_start = pygame.transform.scale(pygame.image.load('spirit_3.png').convert_alpha(), (200, 200))
spirit_1_start = pygame.transform.scale(pygame.image.load('spirit_3.png').convert_alpha(), (200, 200))
spirit_2_start = pygame.transform.scale(pygame.image.load('spirit_0.png').convert_alpha(), (200, 200))
spirit_3_start = pygame.transform.scale(pygame.image.load('spirit_1.png').convert_alpha(), (200, 200))
spirit_4_start = pygame.transform.scale(pygame.image.load('spirit_2.png').convert_alpha(), (200, 200))
...
spirit_0_game = pygame.transform.scale(pygame.image.load('spirit_3.png').convert_alpha(), (150, 150))
spirit_1_game = pygame.transform.scale(pygame.image.load('spirit_3.png').convert_alpha(), (150, 150))
spirit_2_game = pygame.transform.scale(pygame.image.load('spirit_0.png').convert_alpha(), (150, 150))
spirit_3_game = pygame.transform.scale(pygame.image.load('spirit_1.png').convert_alpha(), (150, 150))
spirit_4_game = pygame.transform.scale(pygame.image.load('spirit_2.png').convert_alpha(), (150, 150))
...
nox1 = pygame.transform.scale(pygame.image.load('spirit_3.png').convert_alpha(), (65, 65))
nox2 = pygame.transform.scale(pygame.image.load('spirit_3.png').convert_alpha(), (65, 65))
nox3 = pygame.transform.scale(pygame.image.load('spirit_0.png').convert_alpha(), (65, 65))
nox4 = pygame.transform.scale(pygame.image.load('spirit_1.png').convert_alpha(), (65, 65))
nox5 = pygame.transform.scale(pygame.image.load('spirit_2.png').convert_alpha(), (65, 65))
NOX_JUMP = pygame.transform.scale(pygame.image.load('spirit_1.png').convert_alpha(), (65, 65))
...
def sql_score():
    con = c.connect(host="localhost", user="root", password="pass@23", database="nox")
    cursor = con.cursor()
            ...
            if GAME_ACTIVE:
                ...
                if e.type == pygame.KEYDOWN and NOX_RECT.bottom >= 350:
                    if e.key == pygame.K_SPACE:
                        pygame.mixer.Sound('jump_sound.mp3').play()
                        NOX_GRAVITY = -20
            else:
...
def health():
    ...
    if music1_button.draw(SCREEN):
        mixer.music.load('Equity_music.mp3')
        mixer.music.play(-1)
    if music2_button.draw(SCREEN):
        mixer.music.load('TheWanderer_music.mp3')
        mixer.music.play(-1)
    if music3_button.draw(SCREEN):
        mixer.music.load('SailingAway_sound.mp3')
        mixer.music.play(-1)
...
def main():
    ...
    menu_state = "main"
    game_start = False
    mixer.music.load('AQuietDay_music.mp3')
    mixer.music.play(-1)
    while run:
        if game_start:
            if menu_state == 'main':
